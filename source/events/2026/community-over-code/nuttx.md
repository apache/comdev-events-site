---
title: "Apache NuttX — Hackathon at Community over Code Glasgow 2026"
---
...
* **Alin Jerpelea** — jerpelea@apache.org
...
We will introduce you to NuttX RTOS and show you how to build and run it
from scratch on an embedded board. There will be twenty
[SONY Spresense](https://developer.spresense.sony-semicon.com/) IoT boards
available for demos and demonstrations.

You can also bring your favourite board and we can try to run NuttX on it as well.
See the [list of supported platforms](https://nuttx.apache.org/docs/latest/platforms/index.html).
...
* [Contribution guide](https://nuttx.apache.org/docs/latest/contributing/guide.html)
* [Dev mailing list thread about the hackathon](https://lists.apache.org/thread/cb0yx6mfxh2j7m6hgq8d7vlgd89h0c28)
* [GitHub issues](https://github.com/apache/nuttx/issues)
* [Community channels](https://nuttx.apache.org/community/)
* [Dev environment setup](https://nuttx.apache.org/docs/latest/quickstart/install.html)

### Who's Planning to Attend

<!-- Optional — list community members who plan to be at the hackathon.
     This helps participants know who they can turn to for help. Remove
...
1. Clone the repo and get the build working: [setup instructions](https://nuttx.apache.org/docs/latest/quickstart/install.html)
