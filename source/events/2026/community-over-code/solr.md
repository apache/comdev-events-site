...
* **Good first issues** — small, well-scoped tasks suitable for new
  contributors: [JIRA issues labeled "newdev"](https://issues.apache.org/jira/browse/SOLR-18320?jql=project%20%3D%20SOLR%20AND%20status%20in%20(Open%2C%20Reopened%2C%20%22Patch%20Available%22)%20AND%20labels%20%3D%20newdev)
...
1. Clone the repo and get the build working: [setup instructions](https://github.com/apache/solr/blob/main/dev-docs/solr-source-code.adoc)
