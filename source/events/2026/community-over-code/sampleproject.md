---
title: "Apache YourProject — Hackathon at Community over Code Glasgow 2026"
---
...
* **Good first issues** — small, well-scoped tasks suitable for new
  contributors: [GitHub issues labeled "good first issue"](https://github.com/apache/yourproject/issues?q=label%3A%22good+first+issue%22)
...
* [Contribution guide](https://yourproject.apache.org/contributing.html)
* [Dev mailing list thread about the hackathon](https://lists.apache.org/thread/XXXXX)
* [GitHub issues](https://github.com/apache/yourproject/issues)
* [Slack / Discord / chat channel](https://link-to-chat)
* [Dev environment setup](https://yourproject.apache.org/dev-setup.html)
...
1. Clone the repo and get the build working: [setup instructions](https://yourproject.apache.org/dev-setup.html)
