...
* **Good first issues** — small, well-scoped tasks suitable for new
  contributors: [GitHub issues labeled "good first issue"](https://github.com/apache/fineract/issues?q=label%3A%22good+first+issue%22)
...
* [Contribution guide](https://fineract.apache.org/docs/contributor/)
* [Dev mailing list thread about the hackathon](https://lists.apache.org/thread/kvp25nx027ypky93rgo2g6ylbf61w5oh)
...
1. Clone the repo and get the build working: [setup instructions](https://github.com/apache/fineract#building)
